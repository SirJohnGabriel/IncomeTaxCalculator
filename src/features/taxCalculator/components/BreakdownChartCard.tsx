        ...
        {hasData ? (
            ...
            <PieChart>
              ...
              <Tooltip
                content={({ active, payload }) => {
                  ...
                  const sliceColor = entry.payload.color;
                  ...
                  return (
                    ...
                    >
                      ...
                      <p
                        style={{ color: isDark ? "#ffffff" : "#1a1918" }}
                        className="font-mono font-bold"
                      >
                        ₱ {fmt(value)}
                      </p>
                      <p style={{ color: sliceColor }}>{pct}%</p>
                    </div>
                  );
                }}
              />
              <Legend
                content={() => (
                  ...
                  >
                    {pieSlices
                      .filter((s) => pieData.some((d) => d.name === s.name))
                      .map((s) => (
                        <li
                          key={s.name}
                          style={{
          ...
          <div className="flex flex-col items-center gap-2 py-10 text-center">
            ...
            <p className="text-white/25 text-sm">
              Enter an income and calculate to see the breakdown
            </p>
          </div>
        )}
      </CardContent>

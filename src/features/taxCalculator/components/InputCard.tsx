...
function SchemeOption({ value, selected, label, sublabel, onChange }: SchemeOptionProps) {
    return (
        <button
        ...
        >
            <div className="flex items-center gap-2">
                <span className={cn(
                    ...
                    {selected && <span className="w-1.5 h-1.5 rounded-full bg-dash-green block" />}
                </span>
        ...
        <Card className="flex-2 min-w-[320px] bg-card border-white/5">
            ...
            <CardContent className="px-7 pb-7 space-y-5">
                ...
                <SegmentedControl
                    ...
                    options={[
                        { value: 'employed',      label: 'Employed',     icon: <UserCheck className="w-3.5 h-3.5" /> },
                ...
                <div className="flex gap-4 items-end flex-wrap">
                    <NumericField
                        label={isSelfEmployed ? 'Monthly Gross Income' : 'Monthly Basic Salary'}
                        rawValue={incomeRaw}
                        ...
                        {flatRateExceeded && (
                            <div className="flex items-start gap-2 bg-amber-500/10 border border-amber-500/25 rounded-xl px-4 py-3 mt-1">
                                ...
                                <p className="text-amber-300 text-xs leading-relaxed">
                                    Monthly income of ₱{fmt(parsedIncome)} exceeds the ₱250,000/month (₱3M/year) threshold for 8% flat rate.

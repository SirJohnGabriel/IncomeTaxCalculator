...
const PIE_COLORS_DARK = ["#7EC341", "#B7EE7C", "#D8F8B4"];
const PIE_COLORS_LIGHT = ["#8641c3", "#b57de0", "#e4cff5"];

function getPieSlicesEmployed(isDark: boolean) {
  const c = isDark ? PIE_COLORS_DARK : PIE_COLORS_LIGHT;
  return [
    { name: "Basic Salary After Taxes", color: c[0] },
    { name: "Deductions", color: c[1] },
    { name: "Allowances", color: c[2] },
  ];
}

function getPieSlicesSelf(isDark: boolean) {
  const c = isDark ? PIE_COLORS_DARK : PIE_COLORS_LIGHT;
  return [
    { name: "Net Income", color: c[0] },
    { name: "Deductions", color: c[1] },
  ];
}
...
export function TaxDashboard() {
  ...
  const pieSlices = isSelfEmployed
    ? getPieSlicesSelf(isDark)
    : getPieSlicesEmployed(isDark);
  const pieData = isSelfEmployed
    ? [
        { ...pieSlices[0], value: r?.NetSalary ?? 0 },
        { ...pieSlices[1], value: r?.TotalDeductions ?? 0 },
      ].filter((d) => d.value > 0)
    : [
        {
          ...pieSlices[0],
        ...
        { ...pieSlices[1], value: r?.TotalDeductions ?? 0 },
        { ...pieSlices[2], value: r?.UntaxableIncome ?? 0 },
      ].filter((d) => d.value > 0);

  // True when the user selected flat8 but the calculator switched to graduated due to the ₱3M threshold
  const effectiveSchemeSwitched =
    taxScheme === "flat8" && r?.TaxScheme === "graduated";
  ...
  return (
    ...
    >
      <Helmet>
        <title>
          Philippine Income Tax Calculator 2026 | BIR, SSS, PhilHealth, Pag-IBIG
        </title>
        <meta
          name="description"
          content="Free Philippine income tax calculator for 2026. Compute your BIR withholding tax, net take-home pay, SSS, PhilHealth, and Pag-IBIG contributions instantly. For employed and self-employed individuals."
        />
        <link
          rel="canonical"
          href="https://taxphincomecalculator.netlify.app/"
        />
        <meta
          property="og:title"
          content="Philippine Income Tax Calculator 2026"
        />
        <meta
          property="og:description"
          content="Free Philippine income tax calculator. Compute BIR withholding tax, SSS, PhilHealth, Pag-IBIG, and take-home pay instantly."
        />
        <meta
          property="og:url"
          content="https://taxphincomecalculator.netlify.app/"
        />
      </Helmet>
        ...
        <main className="flex-1 min-w-0 pb-12 space-y-5">
          ...
          <div className="pt-2">
            ...
            <p className="text-white/45 text-sm mt-2 max-w-2xl leading-relaxed">
              Compute your Philippine income tax, SSS, PhilHealth, and Pag-IBIG
              contributions instantly. This calculator uses the latest BIR tax
              rates under the TRAIN Law (RA 10963) and updated 2025 contribution
              schedules to estimate your monthly take-home pay — for both
          ...
          <section className="border-t border-white/6 pt-8 space-y-8 max-w-3xl">
            <div>
              ...
              <p className="text-white/45 text-sm leading-relaxed">
                Under the TRAIN Law, Philippine income tax is computed using a
                graduated tax table based on your annual taxable income. Your
                monthly basic salary is first reduced by mandatory government
                contributions (SSS, PhilHealth, Pag-IBIG), and the resulting
                taxable income is applied against the BIR withholding tax
                brackets. This calculator handles all of that automatically —
                just enter your gross monthly salary and non-taxable allowances
                to get your estimated take-home pay.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-white/45 text-sm leading-relaxed">
                Employees earning up to ₱250,000 annually are exempt from income
                tax. Income above that is taxed at progressive rates ranging
                from 15% to 35%. For self-employed individuals with annual gross
                receipts not exceeding ₱3,000,000, the optional 8% flat tax rate
                on gross income (in excess of ₱250,000) may be available as an
                alternative to the graduated rates.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-white/45 text-sm leading-relaxed">
                Mandatory government contributions are deducted from your gross
                salary before tax is computed. PhilHealth contribution is 5% of
                monthly salary (split equally between employee and employer,
                capped at ₱5,000 total). SSS contributions follow a contribution
                table based on salary brackets. Pag-IBIG (HDMF) is 1% of salary
                for employees earning up to ₱1,500, and 2% above that, capped at
                ₱200/month for the employee share.
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-white/40 text-sm leading-relaxed">
                    Yes. This tool uses the BIR withholding tax table effective
                    for 2023 onwards under the TRAIN Law, along with the latest
                    SSS, PhilHealth, and Pag-IBIG contribution schedules as of
                    2025. Results are estimates — consult a CPA for official tax
                    computations.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-white/40 text-sm leading-relaxed">
                    Non-taxable allowances include de minimis benefits such as
                    rice allowance, transportation allowance, clothing
                    allowance, and similar benefits up to BIR-prescribed limits.
                    These are excluded from your taxable income, reducing your
                    withholding tax.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-white/40 text-sm leading-relaxed">
                    Employed individuals have their SSS and PhilHealth
                    contributions split with their employer. Self-employed
                    individuals cover all contributions on their own and may
                    choose between the graduated tax rates or the optional 8%
                    flat rate if their annual gross income does not exceed
                    ₱3,000,000.
                  </p>
                </div>
              </div>
      ...
      <footer className="border-t border-white/6 mt-4 px-4 md:px-8 py-8">
        <div className="max-w-4xl mx-auto space-y-3 text-center">
          <p className="text-[0.72rem] text-white/35 leading-relaxed">
            ...
            This calculator is intended for general informational and estimation
            purposes only. Results are based on the Philippine TRAIN Law
            (Republic Act No. 10963) tax tables and government contribution
            schedules (SSS, PhilHealth, and Pag-IBIG) as updated in{" "}
            <span className="text-white/50">March 2026</span>. Contribution
            rates and tax brackets are subject to change by the respective
            government agencies.
          </p>
          <p className="text-[0.72rem] text-white/30 leading-relaxed">
            This tool does not constitute professional tax, financial, or legal
            advice. For official computations, complex tax situations, or filing
            requirements, consult the{" "}
            <span className="text-white/45">
              Bureau of Internal Revenue (BIR)
            </span>{" "}
            or a licensed Certified Public Accountant (CPA). The developer
            assumes no liability for any decisions made based on the results
            produced by this calculator.
          </p>
          <p className="text-[0.65rem] text-white/20">
            Data last updated: March 2026 &nbsp;·&nbsp; PH Income Tax Calculator
